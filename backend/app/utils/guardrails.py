...
def check_security(user_input: str) -> SecurityCheck:
    ...
    Business-legitimate queries like "extract the applicant name from the PDF" or "find contact details in the document"  or "Pan details"should ALWAYS be marked as SAFE.
